...
public class MyServlet extends HttpServlet {
    ...
    HashMap<String, String> mUsernameMap = new HashMap<>();
        ...
        try {
            switch (type) {
                case "saveToken":
                    ...
                    mUsernameMap.put(userId, username);
                ...
                case "requestTarget":
                    ...
                    sendPushNotification(userId, username, targetToken, timeInMillis, message, alarmId, "requestTarget");
                    pushFCMNotification(userId, username, targetToken, timeInMillis, message, alarmId, "requestTarget");
                    break;
                case "requestAccepted":
                    requestToken = mUserIdTokenMap.get(targetId);
                    username = mUsernameMap.get(targetId);
                    sendPushNotification(userId, username, requestToken, "", "", alarmId, "requestAccepted");
                    pushFCMNotification(userId, username, requestToken, "", "", alarmId, "requestAccepted");
                    break;
                case "requestRejected":
                    requestToken = mUserIdTokenMap.get(targetId);
                    username = mUsernameMap.get(targetId);
                    sendPushNotification(userId, username, requestToken, "", "", "", "requestRejected");
                    pushFCMNotification(userId, username, requestToken, "", "", "", "requestRejected");
                    break;
                case "sendP2PMessage":
                    targetToken = mUserIdTokenMap.get(targetId);
                    username = mUsernameMap.get(targetId);
...
// userDeviceIdKey is the device id you will query from your database
    ...
    public static void pushFCMNotification(String userDeviceIdKey, String username, String token, String time, String message, String alarmId, String type) throws Exception{
    ...
    private void pushFCMp2p(String userId, String username, String targetToken, String messageType, String message){
        try {
            String authKey = AUTH_KEY_FCM;   // You FCM AUTH key
            String FMCurl = API_URL_FCM;
    ...
    private void sendPushNotification(String userId, String username, String targetToken, String timeInMillis,
    ...
    private void sendP2PMessage(String userId, String username,  String targetToken, String messageType, String message){
        try {
            Sender sender = new Sender(API_KEY);
            // use this to send message with payload data
